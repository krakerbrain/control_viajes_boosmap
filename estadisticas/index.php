    ...
    <table class="table table-striped mt-3 table-sm">
        <thead class="table-danger text-center">
            <td class='p1' style="cursor:pointer" title="Puede ordenar por destino"
                onclick="viajesporruta(true,'destino')">Destino <i id="iconoOrdenDestino" class="fas fa-sort"></i></td>
            <td class='p1' style="cursor:pointer" title="Puede ordenar por cantidad de viajes"
                onclick="viajesporruta(true,'conteo')">Viajes x Mes <i id="iconoOrdenViajesMes" class="fas fa-sort"></i>
            </td>
        </thead>
