<div class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="modalDetalles"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="checkPeaje"
                        onchange="checkPeaje(event)">
                    <label class="form-check-label" for="checkPeaje">
                        Agrega Peaje
                    </label>
                </div>
                <div>
                    <input type="number" name="montoPeaje" id="montoPeaje" placeholder="Monto Peaje" class="my-1"
                        oninput="escribeMontoPeaje()" disabled>
                    <i id="iconAgregarPeaje" class="fa-solid fa-check text-muted mx-3"
                        onclick="agregaDato('Peaje')"></i>
                    <i id="iconBorrarPeaje" class='fa-solid fa-xmark text-muted'
                        onclick="limpiaInput('montoPeaje')"></i>
                </div>
                <div class="form-check">
                ...
                <div class="form-check d-flex my-1">
                    <div class="mr-5">
                        <input class="form-check-input" type="checkbox" value="" id="checkBruto"
                            onchange="checkTipoMonto(event)" disabled>
                        <label class="form-check-label" for="checkBruto">
                            Bruto
                        </label>
                    </div>
                    <div>
                        <input class="form-check-input" type="checkbox" value="" id="checkLiquido"
                            onchange="checkTipoMonto(event)" disabled>
                ...
                <div>
                    <input type="number" name="montoExtra" id="montoExtra" placeholder="Monto Extra"
                        onkeyup="calculomonto(this)" oninput="cambiaIconos('activa', 'Extra')" disabled>
                    <span id="calculoMonto">$0</span>
                    <i id="iconAgregarExtra" class="fa-solid fa-check text-muted mx-3"
                        onclick="agregaDato('Extra')"></i>
                    <i id="iconBorrarExtra" class='fa-solid fa-xmark text-muted'
                        onclick="limpiaInput('montoExtra')"></i>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="modalConfirm"
                    onclick="guardarDetalles()">Guardar</button>
            </div>
        </div>
    </div>
</div>
